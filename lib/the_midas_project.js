...
Crafty.c("Player", {
    ...
    _tradeItems: [],
    init: function() {
        this.requires("Actor, Twoway, Collision, WiredHitBox, Delay, Persist, Solid, Color, Gravity").color("black").gravity("Floor").attr({
            w: 64,
            h: 64
        }).gravityConst(.6).twoway(this._moveSpeed, this._jumpSpeed).bind("EnterFrame", function(data) {
            this.checkDead();
...
var labLvl1 = [ "################################################################################", "################################################################################", "################################################################################", "################################################################################", "################################################################################", "################################################################################", "###############ffffffff###ffffffffff############################################", "##############fffffffff###ffffffffff############################################", "#@##########fffffffffff###ffffffffff############################################", "fffffffffffffffffffffff###ffffffffff############################################" ];
