            ...
            touchDispatch: function(e) {
                ...
                if (touches.length === 1) {
                    ...
                    if (curTouchIndex1 < 0) {
                        ...
                        Crafty.touches[0] = null;
                        Crafty.touches[1] = touches[0].identifier;
                    }
                    if (curTouchIndex2 < 0) {
                ...
                if (tar.nodeName != "CANVAS") {
                    ...
                    ent = Crafty(parseInt(tar.id.replace("ent", ""), 10));
                    if (ent.has("Touch") && ent.isAt(x, y) || ent.isAt(x2, y2)) closest = ent;
                }
                if (first && second) {
                    if (!closest) {
                        q = Crafty.map.search({
                ...
                if (closest && closest2) {
                    if (type === "touchstart") {
                        closest.trigger("TouchStart1", e);
                        closest2.trigger("TouchStart2", e);
                    } else if (type == "touchend") {
                        closest.trigger("TouchEnd1", e);
                        closest2.trigger("TouchEnd2", e);
                    } else if (type == "touchmove") {
                        closest.trigger("TouchMove1", e);
                        closest2.trigger("TouchMove2", e);
                    } else if (type === "touchcancel") {
                        closest.trigger("TouchCancel1", e);
                        closest2.trigger("TouchCancel2", e);
                    } else if (type === "touchleave") {
                        closest.trigger("TouchLeave1", e);
                        closest2.trigger("TouchLeave2", e);
                    }
                } else if (closest) {
                    if (type === "touchstart") {
                        closest.trigger("TouchStart1", e);
