        ...
        Crafty.extend({
            ...
            mouseDispatch: function(e) {
                ...
                if (closest) {
                    ...
                    } else if (type === "mousedown0") {
                        closest.trigger("MouseDownTP1", e);
                    } else if (type === "mouseup0") {
                        closest.trigger("MouseUpTP1", e);
                    } else if (type == "dblclick0") {
                        closest.trigger("DoubleClickTP1", e);
                    } else if (type == "click0") {
                        closest.trigger("ClickTP1", e);
                    } else if (type === "mousemove0") {
                        closest.trigger("MouseMoveTP1", e);
                        if (this.over !== closest) {
                            if (this.over) {
                                this.over.trigger("MouseOutTP1", e);
                                this.over = null;
                            }
                            this.over = closest;
                            closest.trigger("MouseOverTP1", e);
                        }
                    } else if (type === "mousedown1") {
                        closest.trigger("MouseDownTP2", e);
                    } else if (type === "mouseup1") {
                        closest.trigger("MouseUpTP2", e);
                    } else if (type == "dblclick1") {
                        closest.trigger("DoubleClickTP2", e);
                    } else if (type == "click1") {
                        closest.trigger("ClickTP2", e);
                    } else if (type === "mousemove1") {
            ...
            touchDispatch: function(e) {
                ...
                for (var i = 0; i <= e.changedTouches.length; i++) {
                    ...
                    if (e.changedTouches[i]) {
                        ...
                        simulatedEvent.initMouseEvent(type + i, true, true, window, 1, changedTouches[i].screenX, changedTouches[i].screenY, changedTouches[i].clientX, touches[i].clientY, false, false, false, false, 0, e.relatedTarget);
                        changedTouches[i].target.dispatchEvent(simulatedEvent);
                        if (lastEvent !== null && lastEvent.type == "mousedown" + i && type == "mouseup" + i) {
                            console.log("test");
                            type = "click" + i;
                            simulatedEvent = document.createEvent("MouseEvent");
                            simulatedEvent.initMouseEvent(type, true, true, window, 1, changedTouches[i].screenX, changedTouches[i].screenY, changedTouches[i].clientX, changedTouches[i].clientY, false, false, false, false, 0, e.relatedTarget);
                            changedTouches[i].target.dispatchEvent(simulatedEvent);
                        }
                    }
                }
...
Crafty.c("Mountain", {
    init: function() {
        this.requires("Scenery, Color, Mouse").color("brown");
        this.h = 100;
        this.w = 100;
