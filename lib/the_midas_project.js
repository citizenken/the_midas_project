(function e(t, n, r) {
    ...
    8: [ function(require, module, exports) {
        ...
        Crafty.extend({
            ...
            touchDispatch: function(e) {
                ...
                if (tar.nodeName != "CANVAS") {
                    ...
                    ent = Crafty(parseInt(tar.id.replace("ent", ""), 10));
                    if (ent.has("Mouse") && ent.isAt(x, y) || ent.isAt(x2, y2)) closest = ent;
                }
                if (first && second) {
                    if (!closest) {
                        q = Crafty.map.search({
                ...
                if (closest && closest2) {
                    if (type === "tap") {
                        ...
                        closest.trigger("Drag1", e);
                        closest2.trigger("Drag2", e);
        ...
        Crafty.c("Draggable", {
            ...
            enableDrag: function() {
                if (Crafty.mobile) {
                    this.bind("TouchDrag", this._ondown);
                } else {
            ...
            disableDrag: function() {
                if (Crafty.mobile) {
                    this.unbind("TouchDrag", this._ondown);
                } else {
