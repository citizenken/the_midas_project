...
Crafty.c("Player", {
    ...
    _tradeItems: [],
    init: function() {
        this.requires("Actor, Twoway, Collision, Delay, Persist, Solid, Color, Gravity").color("black").gravity("Floor").twoway(this._moveSpeed, this._jumpSpeed).bind("EnterFrame", function(data) {
            this.checkDead();
        }).bind("KeyDown", function(e) {
            switch (e.key) {
