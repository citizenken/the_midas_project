...
Crafty.c("Player", {
    ...
    _tradeItems: [],
    init: function() {
        this.requires("Actor, Twoway, Collision, WiredHitBox, Delay, Persist, Solid, Color, Gravity").color("black").gravity("Floor").gravityConst(.6).twoway(this._moveSpeed, this._jumpSpeed).bind("EnterFrame", function(data) {
            this.checkDead();
        });
    ...
    at: function(x, y) {
        if (x === undefined && y === undefined) {
            return {
                ...
                x_max: this.x / Game.map_grid.tile.width + Game.map_grid.tile.width,
                y: this.y / Game.map_grid.tile.height,
                y_max: this.y / Game.map_grid.tile.height + Game.map_grid.tile.height
            };
        } else {
            this.attr({
                ...
                y_max: y * Game.map_grid.tile.height + Game.map_grid.tile.height
            });
            return this;
        }
    }
...
var labLvl1 = [ "################################################################################", "################################################################################", "################################################################################", "################################################################################", "################################################################################", "#################b##############################################################", "###############ffffffff###ffffffffff############################################", "#@############fffffffff###ffffffffff############################################", "############fffffffffff###ffffffffff############################################", "fffffffffffffffffffffff###ffffffffff############################################" ];
