...
Crafty.c("Player", {
    ...
    init: function() {
        ...
        this.addArms();
        this.color("black").gravity("Floor").gravityConst(.6).twoway(this._moveSpeed, this._jumpSpeed).bind("EnterFrame", function(data) {
            this.checkDead();
        });
...
Crafty.c("Arm", {
    ...
    init: function() {
        ...
        this.requires("2D, Canvas, Color, MouseFace, Touch");
        this.origin(5, 5);
        this.attr({
            move: {
                left: false,
...
Crafty.scene("Loading", function() {
    ...
    Crafty.load([ "assets/actors/camel.png", "assets/actors/player_character.png", "assets/actors/lead_camel_white.png", "assets/tiles/desert_objects_32.png", "assets/tiles/desert_objects_64.png", "assets/tiles/desert_objects_32x64.png" ], function() {
...
var labLvl1 = [ "################################################################################", "################################################################################", "################################################################################", "################################################################################", "################################################################################", "#################b##############################################################", "###############ffffffff###ffffffffff############################################", "#@#####b######fffffffff###ffffffffff############################################", "############fffffffffff###ffffffffff############################################", "fffffffffffffffffffffff###ffffffffff############################################" ];
