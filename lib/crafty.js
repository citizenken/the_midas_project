    ...
    mouseDispatch: function (e) {
        ...
        if (closest) {
            ...
            if (type === "mousedown") {
                ...
                if (this.over !== closest) { //if new mousemove, it is over
                    if (this.over) {
                        this.over.trigger("MouseOutTP1", e); //if over wasn't null, send mouseout
                        this.over = null;
                    }
                    this.over = closest;
