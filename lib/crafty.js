...
Crafty.extend({
    ...
    touchDispatch: function (e) {
        ...
        console.log('second', second, Crafty.touches.second)
            ...
            Crafty.touches.first = e.touches[0].identifier;
            if (e.touches.length > 1) {
                console.log('there are 2 touches');
                second = e.touches[1];
                Crafty.touches.second = e.touches[1].identifier;
                type2 = type + 2;
            }*/
...
/*        var simulatedEvent = document.createEvent("MouseEvent");
        ...
        if (e.touches.length > 1) {
            var simulatedEvent = document.createEvent("MouseEvent");
            simulatedEvent.initMouseEvent(type2, true, true, window, 1,
                second.screenX,
                second.screenY,
                second.clientX,
                second.clientY,
            ...
            second.target.dispatchEvent(simulatedEvent);

            // trigger click when it should be triggered
            if (lastEvent !== null && lastEvent.type == 'mousedown2' && type2 == 'mouseup2') {
                type2 = 'click';
